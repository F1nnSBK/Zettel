...
Tags: [[Rentabilität]], [[Grundlagen Finanzierung & Investition]], [[Statische Investitionsrechenverfahren]]
#finance

---
Die **Rentabilitätsvergleichsrechnung** ist ein [[Statische Investitionsrechenverfahren|statisches Investitionsrechenverfahren]]. Es nutzt die *durchschnittliche Rentabilität des eingesetzten Kapitals* (ROI = [[Return on Investment]]) als Entscheidungsgrundlage.

$$
ROI = \frac{EBIT}{\text{Durschn. investiertes Kapital}} = \frac{\text{Gewinn vor Zinskosten und Steuern}}{\text{Durschn. eingesetztes Kapital}}
$$

$$
\text{Durchschnittlich investiertes Kapital} = \frac{Anfangsinvestition + Restwert}{2}
$$
...
* Eine Investition ist vorteilhaft, wenn $ROI > \text{Mindestverzinsung}$ ([[WACC]]/Hurdle Rate).
* Bei Auswahlentscheidung: Wähle die Alternative mit dem maximalen ROI.
...
### Verwendung
```dataview
list from [[Rentabilitätsvergleichsrechnung]]
```